...
class InvoiceRepository:
    ...
    def insert_invoice_headers(self, sale_date, total_amount, user_id):
        stmt = insert(db_context.invoice_header_table).returning(db_context.invoice_header_table.c.id).values(sale_date=sale_date, total_amount=total_amount, user_id=user_id)
