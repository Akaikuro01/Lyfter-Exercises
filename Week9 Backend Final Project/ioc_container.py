...
-----END PRIVATE KEY-----""", 'RS256')
        self.cache_manager = CacheManager(
            host = "redis-19272.c281.us-east-1-2.ec2.redns.redis-cloud.com",
            port = 19272,
            password = "qTHXGFydflwB6WCN59P8kPI46dcLBW6r"
        )
        ...
        self.cart_repository = CartRepository(self.db_context.engine)
        self.payment_method_repository = PaymentMethodsRepository(self.db_context.engine)